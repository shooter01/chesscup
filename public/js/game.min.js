...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(2),m=__webpack_require__(9),p=__webpack_require__(3),v=__webpack_require__(1),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(5);
...
var Timer = function (_React$Component) {
    ...
    _createClass(Timer, [{
        ...
        value: function tick() {
            ...
            // дни
            var days = Math.floor(this.state.timeleft / secondsInADay);

            // часы
            var hourSeconds = this.state.timeleft % secondsInADay;
        ...
        value: function render() {
            return _react2.default.createElement(
                'span',
                null,
                this._isMounted ? _react2.default.createElement(
                    'span',
                    null,
                    this.state.timeleft > 0 ? _react2.default.createElement(
                        'span',
                        null,
...
if (document.getElementById("timer") != null) {
    0;
    (0, _reactDom.render)(_react2.default.createElement(Timer, null), document.getElementById('timer'));
}
...
var _sounds = __webpack_require__(29);
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.socketIOConnect = _this.socketIOConnect.bind(_this);
        _this.tick = _this.tick.bind(_this);
        _this.setTimer = _this.setTimer.bind(_this);
        _this.resign = _this.resign.bind(_this);
        _this.fillMoves = _this.fillMoves.bind(_this);
        _this.addMove = _this.addMove.bind(_this);
        _this.goBack = _this.goBack.bind(_this);
        _this.goForward = _this.goForward.bind(_this);
        _this.scrollToBottom = _this.scrollToBottom.bind(_this);
        _this.rematchClick = _this.rematchClick.bind(_this);
    ...
    _createClass(App, [{
        ...
        key: 'getPromotionChoice',
        value: function getPromotionChoice() {
                ...
                if (data.event === "move") {
                    ...
                    self.setState({
                        ...
                        if (u == p2 && this.state.who_to_move == "black") {
                            if (!is_over) {
                                var _moves2 = self.game.moves({ verbose: true });
                                var _move = _moves2[Math.floor(Math.random() * _moves2.length)];
                                //console.log(move);
                                setTimeout(function () {
                                    self.move(_move.from, _move.to);
                                }, 100);
                            }
                        }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'mt-1 row lichess_ground lichess_board_wrap' },
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'text ulpt name', 'data-pt-pos': 's', href: '', target: '_self' },
                                this.state.up_name,
                                _react2.default.createElement(
                                    'span',
                                    { className: 'rating' },
                                    ' ',
                                    this.state.up_tournaments_rating,
                                    this.state.up_rating_change ? _react2.default.createElement(
                                        'span',
                                        {
                                            className: this.state.up_rating_change >= 0 ? "rp up" : "rp down" },
                                        this.state.up_rating_change > 0 ? "+" : "",
                                        this.state.up_rating_change
                                    ) : null
                                )
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'time aclock' },
                                this.state.up_clock_minutes,
                                _react2.default.createElement(
                                    'span',
                                    { className: 'low' },
                                    ':'
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('div', { id: 'dirty', className: 'cg-board-wrap' })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'clock_bottom' },
                        _react2.default.createElement(
                            'div',
                            {
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'text ulpt name', 'data-pt-pos': 's', href: '',
                                    target: '_self' },
                                this.state.bottom_name,
                                _react2.default.createElement(
                                    'span',
                                    { className: 'rating' },
                                    this.state.bottom_tournaments_rating,
                                    this.state.bottom_rating_change ? _react2.default.createElement(
                                        'span',
                                        {
                                            className: this.state.bottom_rating_change >= 0 ? "rp up" : "rp down" },
                                        this.state.bottom_rating_change > 0 ? "+" : "",
                                        this.state.bottom_rating_change
                                    ) : null
                                )
                            ),
                            _react2.default.createElement(
                                'span',
                                { className: 'time aclock' },
                                this.state.bottom_clock_minutes,
                                _react2.default.createElement(
                                    'span',
                                    { className: 'low' },
                                    ':'
                ...
                _react2.default.createElement(
                    ...
                    clientWidth > 1000 ? _react2.default.createElement(
                        'div',
                        { className: 'table_wrap' },
                        _react2.default.createElement(
                            'div',
                            { className: 'clock clock_top' },
                            _react2.default.createElement(
                                'div',
                                { className: 'time' },
                                this.state.up_clock_minutes,
                                ...
                                _react2.default.createElement(
                                    ...
                                    this.state.up_clock_milliseconds
                                )
                            ),
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'fbt flip hint--top', 'data-hint': '\u041F\u0435\u0440\u0435\u0432\u0435\u0440\u043D\u0443\u0442\u044C \u0434\u043E\u0441\u043A\u0443',
                                                'data-act': 'flip', disabled: true },
                                            _react2.default.createElement('span', { 'data-icon': 'B' })
                                        ),
                                        _react2.default.createElement(
                                            'nav',
                                            null,
                                            _react2.default.createElement('button', { className: 'fbt', 'data-icon': 'W', 'data-ply': '0', disabled: true }),
                                            _react2.default.createElement('button', { className: 'fbt', 'data-icon': 'Y', 'data-ply': '28', disabled: true }),
                                            _react2.default.createElement('button', { className: 'fbt', 'data-icon': 'X', 'data-ply': '30', disabled: true }),
                                            _react2.default.createElement('button', { className: 'fbt', 'data-icon': 'V', 'data-ply': '39', disabled: true })
                                        ),
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'fbt  hint--top', 'data-hint': '\u041F\u0435\u0440\u0435\u0432\u0435\u0440\u043D\u0443\u0442\u044C \u0434\u043E\u0441\u043A\u0443',
                                                'data-act': '', disabled: true },
                                            _react2.default.createElement('span', { 'data-icon': '' })
                                        )
                                    ),
                                    _react2.default.createElement('div', { className: 'moves' })
                                ),
                                this.state.isPlayer ? _react2.default.createElement(
                                    'div',
                                    null,
                                    this.state.is_over == 1 ? _react2.default.createElement(
                                        'div',
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { className: 'text fbt strong glowed', onClick: this.rematchClick, 'data-icon': 'G',
                                                    href: this.state.tourney_href },
                                                this.state.tourney_text
                                            )
                                        )
                                    ) : _react2.default.createElement(
                                        'div',
                                        ...
                                        _react2.default.createElement(
                                            'button',
                                            { disabled: true, className: 'fbt hint--bottom takeback-yes',
                                                'data-hint': '\u041F\u043E\u043F\u0440\u043E\u0441\u0438\u0442\u044C \u0441\u043E\u043F\u0435\u0440\u043D\u0438\u043A\u0430 \u0432\u0435\u0440\u043D\u0443\u0442\u044C \u0445\u043E\u0434' },
                                            _react2.default.createElement('span', { 'data-icon': 'i' })
                                        ),
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'fbt hint--bottom draw-yes', disabled: true,
                                                'data-hint': '\u041F\u0440\u0435\u0434\u043B\u043E\u0436\u0438\u0442\u044C \u043D\u0438\u0447\u044C\u044E' },
                                            _react2.default.createElement('span', { 'data-icon': '2' })
                                        ),
                                        _react2.default.createElement(
                                            'button',
                                            { className: 'fbt hint--bottom resign-confirm',
                                                onClick: this.resign, 'data-hint': '\u0421\u0434\u0430\u0442\u044C\u0441\u044F' },
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement('i', { className: 'line', title: 'Joined the game' }),
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'text ulpt', 'data-pt-pos': 's', href: '', target: '_self' },
                                        this.state.bottom_name
                                    ),
                                    _react2.default.createElement(
                                        'span',
                    ...
                    this.state.p1_won == 1 ? _react2.default.createElement(
                        'div',
                        { className: 'alert alert-secondary mt-1 mb-1 ' },
                        _react2.default.createElement(
                            'b',
                            null,
                            '\u0411\u0435\u043B\u044B\u0435 \u0432\u044B\u0438\u0433\u0440\u0430\u043B\u0438'
                    ...
                    this.state.p2_won == 1 ? _react2.default.createElement(
                        'div',
                        { className: 'alert alert-secondary mt-1 mb-1 ' },
                        _react2.default.createElement(
                            'b',
                    ...
                    this.state.p2_won == 0.5 ? _react2.default.createElement(
                        'div',
                        { className: 'alert alert-secondary mt-1 mb-1 ' },
                        _react2.default.createElement(
                            'b',
                    ...
                    this.state.is_started === 1 || this.state.is_over === 1 ? null : _react2.default.createElement(
                        'div',
                        null,
                        this.state.moves.length == 0 ? _react2.default.createElement(
                            'div',
                            { className: 'alert alert-danger mt-1 mb-1 ', id: 'timeleft_white' },
                            '\u0412\u0440\u0435\u043C\u044F \u043D\u0430 \u0445\u043E\u0434 \u0431\u0435\u043B\u044B\u0445: ',
                            _react2.default.createElement(_Timer2.default, null)
                        ) : null,
                        this.state.moves.length == 1 ? _react2.default.createElement(
                            'div',
                            { className: 'alert alert-danger mt-1 mb-1 ', id: 'timeleft_black' },
                            '\u0412\u0440\u0435\u043C\u044F \u043D\u0430 \u0445\u043E\u0434 \u0447\u0435\u0440\u043D\u044B\u0445: ',
                            _react2.default.createElement(_Timer2.default, null)
                        ) : null
                    ),
                        ...
                        this.state.isPlayer ? _react2.default.createElement(
                            ...
                            this.state.is_over == 1 ? _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'text fbt strong glowed', 'data-icon': 'G', onClick: this.rematchClick,
                                            href: this.state.tourney_href },
                                        this.state.tourney_text
                                    )
                                )
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { className: 'fbt hint--bottom resign-confirm', onClick: this.resign,
                                        'data-hint': '\u0421\u0434\u0430\u0442\u044C\u0441\u044F' },
                                    _react2.default.createElement('span', { 'data-icon': 'b' })
                                )
                            )
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'side_box padded' },
                        _react2.default.createElement(
                            'div',
                            { className: 'players' },
                            _react2.default.createElement(
                                'div',
                                { className: 'player color-icon is white text' },
                                _react2.default.createElement(
                                    'a',
                                    { className: 'user_link ulpt', href: '' },
                                    p1_name,
                                    '\xA0',
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'player color-icon is black text' },
                                _react2.default.createElement(
                                    'a',
                                    { className: 'user_link', href: '' },
                                    p2_name,
                                    '\xA0',
                                    p2_tournaments_rating
                                )
                            )
                        )
                    ),
                    _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement('button', { className: 'fbt mobile-btn d-lg-none', onClick: this.goBack, 'data-icon': 'Y', 'data-ply': '28' }),
                        _react2.default.createElement('button', { className: 'fbt mobile-btn d-lg-none', onClick: this.goForward, 'data-icon': 'X', 'data-ply': '30', disabled: '' })
                    )
                )
            );
        }
...
(0, _reactDom.render)(_react2.default.createElement(App, null), document.getElementById('game'));
