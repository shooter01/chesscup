...
var Chat = function (_React$Component) {
    ...
    _createClass(Chat, [{
        ...
        value: function sendMessage() {
            var textDOM = _reactDom2.default.findDOMNode(this.refs.text);
            var mes = $.trim(textDOM.value);
            // console.log(mes);
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                this.state.chat_id ? _react2.default.createElement(
                    'div',
                    { className: 'chat' },
                    _react2.default.createElement(
                        'div',
                        { className: 'messages p-1', id: 'messages' },
                        this.state.messages.map(function (item, index) {
                            return _react2.default.createElement(
                                'div',
                                { key: index, className: 'mt-1 mt-2' },
                                _react2.default.createElement(
                                    'b',
                                    null,
                                    item.name
                    ...
                    typeof u == "undefined" || u == null ? _react2.default.createElement(
                        'div',
                        { className: 'input-group posAbsolute d-flex justify-content-center align-items-end' },
                        _react2.default.createElement(
                            'a',
                            { href: '/login' },
                            'Login'
                        ...
                        'div',
                        { className: 'input-group posAbsolute' },
                        _react2.default.createElement('input', { onKeyDown: this.handleKeyPress, onInput: this.checkLength, onPaste: this.checkLength, type: 'text', className: 'form-control', ref: 'text', placeholder: 'Message...', 'aria-label': 'Recipient\'s username', 'aria-describedby': 'basic-addon2' }),
                        _react2.default.createElement(
                            'div',
                            { className: 'input-group-append' },
                            _react2.default.createElement(
                                'button',
                                { className: 'btn btn-outline-secondary', type: 'button', onClick: this.sendMessage },
                                'Send'
                            )
                        )
                    )
...
$(function () {
    (0, _reactDom.render)(_react2.default.createElement(Chat, null), document.getElementById('chat'));
});
