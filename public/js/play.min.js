...
var PlaySockets = function (_React$Component) {
    _inherits(PlaySockets, _React$Component);

    function PlaySockets(props) {
        _classCallCheck(this, PlaySockets);

        var _this = _possibleConstructorReturn(this, (PlaySockets.__proto__ || Object.getPrototypeOf(PlaySockets)).call(this, props));
        ...
        value: function componentDidMount() {
            ...
            this.socket = new _ws2.default(function (data) {
                ...
                if (data.action === "games_list") {
                    ...
                    var challenges = JSON.parse(data.challenges);
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('th', { scope: 'col', className: 'text-center' })
                        )
                    ),
                    _react2.default.createElement(
                        'tbody',
                        null,
                        this.state.challenges.map(function (item, index) {
                            return _react2.default.createElement(
                                'tr',
                                { key: index },
                                _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { className: 'text-center' },
                                    _this2.state.user_id != null ? item.owner != _this2.state.user_id ? _react2.default.createElement(
                                        'span',
                                        { className: 'btn btn-primary btn-sm', 'data-game_id': item._id, onClick: _this2.accept },
                                        '\u041F\u0440\u0438\u043D\u044F\u0442\u044C'
                                    ) : _react2.default.createElement(
                                        'span',
                                        { className: 'btn btn-danger btn-sm', 'data-game_id': item._id, onClick: _this2.remove },
                                        '\u0423\u0434\u0430\u043B\u0438\u0442\u044C'
                                    ) : null
                                )
                            );
                        ...
                        this.state.games.map(function (item, index) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { className: 'btn btn-primary btn-sm', href: "/play/game/" + item._id },
                                        '\u0421\u043C\u043E\u0442\u0440\u0435\u0442\u044C'
                                    )
                                )
                            );
...
$(function () {
    (0, _reactDom.render)(_react2.default.createElement(PlaySockets, null), document.getElementById('games'));
});
