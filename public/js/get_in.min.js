...
var GetInButton = function (_React$Component) {
    _inherits(GetInButton, _React$Component);

    function GetInButton(props) {
        _classCallCheck(this, GetInButton);

        var _this = _possibleConstructorReturn(this, (GetInButton.__proto__ || Object.getPrototypeOf(GetInButton)).call(this, props));
    ...
    _createClass(GetInButton, [{
        ...
        key: 'addParticipant',
        value: function addParticipant(event) {
            var that = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'span',
                null,
                this.state.is_in == false ? _react2.default.createElement(
                    'span',
                    { className: 'btn btn-lg btn-success float-right', onClick: this.addParticipant },
                    '\u0423\u0447\u0430\u0441\u0442\u0432\u043E\u0432\u0430\u0442\u044C'
                ) : _react2.default.createElement(
                    'span',
                    { onClick: this.removeParticipant, className: 'btn btn-lg btn-danger float-right' },
                    '\u041F\u043E\u043A\u0438\u043D\u0443\u0442\u044C'
                )
            );
        }
...
(0, _reactDom.render)(_react2.default.createElement(GetInButton, null), document.getElementById('get_in'));
