...
var _BreadCumbs = __webpack_require__(31);

var _BreadCumbs2 = _interopRequireDefault(_BreadCumbs);

var _ModalInput = __webpack_require__(26);

var _ModalInput2 = _interopRequireDefault(_ModalInput);

var _UserTable = __webpack_require__(32);
...
var UserList = function (_React$Component) {
    ...
    function UserList(props) {
        ...
        _this.method = _this.method.bind(_this);
        _this.setAddType = _this.setAddType.bind(_this);
        _this.editModal = _this.editModal.bind(_this);
        _this.addModal = _this.addModal.bind(_this);
        _this.renderPos = _this.renderPos.bind(_this);
    ...
    _createClass(UserList, [{
        ...
        value: function render() {
            ...
            if (this.state.request_sent === false) {
                table = _react2.default.createElement(_UserTable2.default, { data: this.state.users, editModal: this.editModal });
            } else {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_BreadCumbs2.default, null),
                _react2.default.createElement(_Tabs2.default, { someMethod: this.method, addModal: this.addModal }),
                table,
                _react2.default.createElement(
                    'div',
...
(0, _reactDom.render)(_react2.default.createElement(UserList, null), document.getElementById('users'));
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "div",
                    { className: "progress" },
                    _react2.default.createElement("div", { className: "progress-bar progress-bar-striped progress-bar-animated",
                        role: "progressbar", "aria-valuenow": "75", "aria-valuemin": "0", "aria-valuemax": "100", style: spanStyle })
                )
            );
        }
    }]);
...
var BreadCumbs = function (_React$Component) {
    _inherits(BreadCumbs, _React$Component);

    function BreadCumbs() {
        _classCallCheck(this, BreadCumbs);

        return _possibleConstructorReturn(this, (BreadCumbs.__proto__ || Object.getPrototypeOf(BreadCumbs)).apply(this, arguments));
    }

    _createClass(BreadCumbs, [{
        key: 'render',
        value: function render() {
            return _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'col-lg-12 d-none d-lg-block' },
                        _react2.default.createElement(
                            'nav',
...
var UserTable = function (_React$Component) {
    ...
    _createClass(UserTable, [{
        key: 'editModal',
        value: function editModal(event) {
                        ...
                        users.map(function (item, index) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { style: width },
                                    _react2.default.createElement('i', { className: 'fa fa-edit btn btn-success', 'data-id': index, onClick: _this2.editModal })
                                )
                            );
                        })
                    )
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { className: 'nav-link active', 'data-id': 'admin', onClick: this.showTab, id: 'admin-tab', 'data-toggle': 'pill', href: '#pills-home', role: 'tab', 'aria-controls': 'pills-home', 'aria-expanded': 'true' },
                            '\u0410\u0434\u043C\u0438\u043D\u0438\u0441\u0442\u0440\u0430\u0442\u043E\u0440\u044B'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { className: 'nav-link', id: 'teacher-tab', 'data-toggle': 'pill', href: '#pills-profile', role: 'tab', 'aria-controls': 'pills-profile', 'aria-expanded': 'true', 'data-id': 'teacher', onClick: this.showTab },
                            '\u041F\u0440\u0435\u043F\u043E\u0434\u0430\u0432\u0430\u0442\u0435\u043B\u0438'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'a',
                            { className: 'nav-link', id: 'students-tab', 'data-toggle': 'pill', href: '#pills-profile', role: 'tab', 'aria-controls': 'pills-profile', 'aria-expanded': 'true', 'data-id': 'student', onClick: this.showTab },
                            '\u0423\u0447\u0435\u043D\u0438\u043A\u0438'
                        )
                    ),
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: 'btn btn-success float-right', onClick: this.props.addModal },
                            '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C'
                        )
                    )
                )
