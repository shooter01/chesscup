        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.state.request_sent == true ? _react2.default.createElement(
                    ...
                    'div',
                    null,
                    this.state.pairing.map(function (item, index) {
                        return _react2.default.createElement(
                            'div',
                            { key: index },
                            _this2.state.current_games[item.id] ? _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(Link, { tournament_id: _this2.state.tournament_id, p2_name: item.p2_name, p1_name: item.p1_name, id: item.id })
                            ) : null
                        );
                    })
                )
...
var Link = function (_React$Component2) {
    ...
    function Link(props) {
        ...
        _this3.state = {
            id: _this3.props.id,
            p1_name: _this3.props.p1_name,
            p2_name: _this3.props.p2_name,
            tournament_id: _this3.props.tournament_id
        };
        return _this3;
    }
...
(0, _reactDom.render)(_react2.default.createElement(CurrentGames, null), document.getElementById('current_games'));
