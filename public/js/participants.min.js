...
var ParticipantsListTable = function (_React$Component) {
    _inherits(ParticipantsListTable, _React$Component);

    function ParticipantsListTable(props) {
        _classCallCheck(this, ParticipantsListTable);

        var _this = _possibleConstructorReturn(this, (ParticipantsListTable.__proto__ || Object.getPrototypeOf(ParticipantsListTable)).call(this, props));

        _this.state = {
            participants: _this.props.participants,
            tournament: _this.props.tournament
        };
        _this.removeParticipant = _this.removeParticipant.bind(_this);

        return _this;
    }

    _createClass(ParticipantsListTable, [{
        ...
        value: function removeParticipant(event) {
            event.preventDefault();
            var that = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'table',
                { className: 'table mt-3 table-sm table-hover' },
                _react2.default.createElement(
                    'tbody',
                    null,
                    this.state.participants.map(function (item, index) {
                        return _react2.default.createElement(
                            'tr',
                            { key: index },
                            _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                !tournament.is_online ? _react2.default.createElement(
                                    'span',
                                    { className: 'btn btn-danger font-weight-bold',
                                        'data-id': item.id, style: deleteBtn,
                                        onClick: _this2.removeParticipant },
                                    'x'
                                ) : null
                            )
                        );
    ...
    return ParticipantsListTable;
}(_react2.default.Component);

exports.default = ParticipantsListTable;
...
var ModalInput = function (_React$Component) {
    ...
    function ModalInput(props) {
        ...
        _this.state = {
            ...
            current_type: _this.props.current_type,
    ...
    _createClass(ModalInput, [{
        ...
        key: 'method',
        value: function method(data, respond) {
        ...
        value: function saveUser(event) {
            ...
            if (this.state.request_sent != true) {
                ...
                var url = this.props.mode === "add" ? "/users/save_user" : "/users/update_user";
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'form',
                    { action: '', className: 'col-lg-12', name: 'myform', id: 'myform' },
                    this.state.current_tab != null ? _react2.default.createElement(
                        'div',
                        { className: 'input-group mb-3' },
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'label',
                                    { htmlFor: 'name', className: 'col-form-label small' },
                                    _Name
                                ),
                                _react2.default.createElement('input', { type: 'text', id: 'name', className: 'form-control', placeholder: _Name, name: 'name', required: 'required', 'aria-describedby': 'basic-addon2' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'row' },
                                _react2.default.createElement(
                                    'label',
                                    { htmlFor: 'rating', className: 'col-form-label small' },
                                    _Rating
                                ),
                                _react2.default.createElement('input', { type: 'text', className: 'form-control', defaultValue: '1200', placeholder: _Rating,
                                    name: 'tournaments_rating' })
                            ),
                            _react2.default.createElement('hr', null),
                            this.state.current_tab == "student" ? _react2.default.createElement(
                                'div',
                                { className: 'row' },
                                _react2.default.createElement('div', { className: 'col-5 ml-1' })
                            ) : null
                        )
                    ) : null
                )
...
var _ModalInput = __webpack_require__(26);

var _ModalInput2 = _interopRequireDefault(_ModalInput);

var _TeamsInput = __webpack_require__(35);

var _TeamsInput2 = _interopRequireDefault(_TeamsInput);

var _teams = __webpack_require__(36);

var _teams2 = _interopRequireDefault(_teams);

var _ParticipantsListTable = __webpack_require__(25);

var _ParticipantsListTable2 = _interopRequireDefault(_ParticipantsListTable);
...
var Participants = function (_React$Component) {
    ...
    _createClass(Participants, [{
        ...
        key: 'setHeight',
        value: function setHeight(element) {
        ...
        key: 'removeTeam',
        value: function removeTeam(team_id) {
            var that = this;
            event.preventDefault();
        ...
        key: 'addParticipant',
        value: function addParticipant(event, user) {
            var that = this;
        ...
        key: 'setAddType',
        value: function setAddType(data) {
        ...
        key: 'changeOrder',
        value: function changeOrder(event) {
            var that = this;
            var $target = $(event.target);
        ...
        value: function render() {
            ...
            button = _react2.default.createElement(_ModalInput2.default, { setAddType: this.setAddType,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                _extends({}, linkTo, { className: 'btn btn-primary btn-block btn-lg' }),
                                _ToTournament
                            )
                        )
                    )
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'col-sm-3' },
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', placeholder: _Search, onChange: this.search }),
                    _react2.default.createElement(
                        'div',
                        { className: 'list-group mt-2 school-participants' },
                        this.state.tournament.type != 20 && this.state.filtered.map(function (item, index) {
                            return _react2.default.createElement(
                                'a',
                                { href: '', className: 'list-group-item list-group-item-action', key: index, onClick: _this2.addParticipant, 'data-rating': item.tournaments_rating, 'data-id': item.id },
                                item.name
                            );
                        })
                    )
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'col-sm-9 tournament-participants' },
                    _react2.default.createElement(
                        'ul',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'nav-link active', 'data-id': 'participants', onClick: this.showTab, id: 'admin-tab', 'data-toggle': 'pill', href: '#pills-home', role: 'tab', 'aria-controls': 'pills-home', 'aria-expanded': 'true' },
                                this.state.tournament.type > 10 ? _react2.default.createElement(
                                    'span',
                                    null,
                                    _Teams
                                ) : _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { className: 'nav-link', id: 'students-tab', 'data-toggle': 'pill', href: '#pills-profile', role: 'tab', 'aria-controls': 'pills-profile', 'aria-expanded': 'true', 'data-id': 'admins', onClick: this.showTab },
                                _Administrators
                            )
                        ),
                        this.state.tournament.type > 10 ? _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                { className: 'btn btn-success float-right', onClick: this.addTeamModal },
                                _AddTeam
                            )
                        ) : null,
                        this.state.tournament.type != 20 ? _react2.default.createElement(
                            'li',
                            { className: 'nav-item' },
                            _react2.default.createElement(
                                'span',
                                { className: 'btn btn-success float-right', onClick: this.addModal },
                                _AddParticipant
                            )
                        ) : null
                    ),
                    this.state.tournament.type > 10 && this.state.current_tab !== "admins" ? _react2.default.createElement(_teams2.default, { setTeam: this.setTeam, tournament: this.state.tournament, removeParticipant: this.removeParticipant, removeTeam: this.removeTeam, teams: this.state.teams, current_team: this.state.current_team, changeOrder: this.changeOrder }) : _react2.default.createElement(_ParticipantsListTable2.default, { tournament: this.state.tournament, removeParticipant: this.removeParticipant, participants: this.state.participants })
                ),
                this.state.tournament.type > 10 ? _react2.default.createElement(_TeamsInput2.default, {
                    teachers: this.state.teachers, resetTeam: this.resetTeam, method: this.addTeam, tournament: this.state.tournament }) : null,
                _react2.default.createElement(
                    'div',
                    { className: 'modal ', id: 'addEditModal', tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'exampleModalLabel', 'aria-hidden': 'true' },
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('h5', { className: 'modal-title', id: 'exampleModalLabel' }),
                                _react2.default.createElement(
                                    'button',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement('div', { className: 'alert alert-danger hidden errors' }),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'alert alert-success hidden success' },
                                    _SuccessUpdate
                                ),
                                _react2.default.createElement(_ModalInput2.default, { setAddType: this.setAddType,
                                    current_tab: 'student',
                                    mode: this.state.mode,
                                    current_type: this.state.current_type,
                                    method: this.method,
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { type: 'button', className: 'btn btn-primary', id: 'save_theme' },
                                    _Save
                                )
                            )
                        )
                ...
                this.state.request_sent === true ? _react2.default.createElement(
                    'div',
                    { className: 'd-flex align-items-baseline justify-content-center ', style: save },
                    _react2.default.createElement(
                        'h1',
                        null,
                        _Saving
                    ),
                    _react2.default.createElement('div', { className: '', style: fixed })
                ) : null
            );
        }
    }]);
...
(0, _reactDom.render)(_react2.default.createElement(Participants, null), document.getElementById('participants'));
...
var TeamsInput = function (_React$Component) {
    _inherits(TeamsInput, _React$Component);

    function TeamsInput(props) {
        _classCallCheck(this, TeamsInput);

        var _this = _possibleConstructorReturn(this, (TeamsInput.__proto__ || Object.getPrototypeOf(TeamsInput)).call(this, props));

        _this.state = {
            tournament_id: _this.props.tournament.id
        };
        _this.handleChange = _this.handleChange.bind(_this);
        _this.saveTeam = _this.saveTeam.bind(_this);
        _this.method = _this.method.bind(_this);
        _this.resetTeam = _this.resetTeam.bind(_this);
    ...
    _createClass(TeamsInput, [{
        ...
        key: 'resetTeam',
        value: function resetTeam() {
            this.props.resetTeam();
        }
    }, {
        key: 'saveTeam',
        value: function saveTeam(event) {
            var self = this;
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: 'modal ', id: 'addTeamModal', tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'exampleModalLabel', 'aria-hidden': 'true' },
                _react2.default.createElement(
                    'div',
                    { className: 'modal-dialog modal-lg', role: 'document' },
                    _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                _react2.default.createElement('input', { type: 'text', id: 'name', className: 'form-control', placeholder: _TeamName, name: 'team_name', required: 'required', 'aria-describedby': 'basic-addon2' })
                                            )
                                        )
                                    )
                                )
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-primary', id: 'save_team' },
                                _Save
                            )
                        )
                    )
...
var TeamsList = function (_React$Component) {
    ...
    _createClass(TeamsList, [{
        ...
        key: 'selectTeam',
        value: function selectTeam(event) {
            var that = this;
        ...
        key: 'removeTeam',
        value: function removeTeam(event) {
            var that = this;
            event.preventDefault();
            event.stopPropagation();
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                Object.keys(this.state.teams).map(function (item, index) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'mt-1', key: index },
                        _react2.default.createElement(
                            'div',
                            { className: _this2.props.current_team == _this2.state.teams[item].team_id ? "p-1 mb-2 d-flex justify-content-between team-title participant selected bg-primary text-white" : "p-1 mb-2 bg-light text-dark d-flex justify-content-between team-title participant ", 'data-id': item, onClick: _this2.selectTeam },
                            _react2.default.createElement(
                                'div',
                                null,
                                _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'span',
                                null,
                                _this2.props.current_team == _this2.state.teams[item].team_id ? null : _react2.default.createElement(
                                    'span',
                                    { 'data-id': item, onClick: _this2.selectTeam, className: 'select-team-btn mr-3' },
                                    _ChooseTeam
                                ),
                                _react2.default.createElement('a', { href: '', className: 'fa fa-trash trash-team text-dark mr-1 mt-1', 'data-id': item, title: '\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u043A\u043E\u043C\u0430\u043D\u0434\u044B', onClick: _this2.removeTeam })
                            )
                        ),
                        _this2.state.teams[item].users.length > 0 ? _react2.default.createElement(
                            'table',
                            { className: 'table table-hover borderless table-sm', key: index },
                            _react2.default.createElement(
                                'thead',
                                null,
                                _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'tbody',
                                null,
                                _this2.state.teams[item].users.map(function (user, index1) {
                                    return _react2.default.createElement(
                                        'tr',
                                        { key: index1, className: 'first-row', 'data-id': _this2.state.teams[item].team_id, 'data-user-id': user.user_id },
                                        _react2.default.createElement(
                                            'th',
                                            { scope: 'row' },
                                            index1 + 1
                                        ...
                                        _react2.default.createElement(
                                            'td',
                                            null,
                                            _react2.default.createElement('span', { className: 'far fa-caret-square-up caret', 'data-action': 'up', 'data-team-id': _this2.state.teams[item].team_id, onClick: _this2.changeOrder, 'data-board': user.team_board, 'data-user-id': user.user_id }),
                                            _react2.default.createElement('span', { className: 'far fa-caret-square-down caret ml-1', 'data-action': 'down', onClick: _this2.changeOrder, 'data-team-id': _this2.state.teams[item].team_id, 'data-board': user.team_board, 'data-user-id': user.user_id })
                                        ),
                                        _react2.default.createElement(
                                            'td',
                                            null,
                                            _react2.default.createElement('a', { href: '', className: 'fa fa-trash float-right', 'data-id': user.user_id, title: '\u0423\u0434\u0430\u043B\u0435\u043D\u0438\u0435 \u0443\u0447\u0430\u0441\u0442\u043D\u0438\u043A\u0430', onClick: _this2.removeParticipant })
                                        )
                                    );
                                })
                            )
