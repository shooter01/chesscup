...
var UserResults = function (_React$Component) {
    _inherits(UserResults, _React$Component);

    function UserResults(props) {
        _classCallCheck(this, UserResults);

        var _this = _possibleConstructorReturn(this, (UserResults.__proto__ || Object.getPrototypeOf(UserResults)).call(this, props));

        _this.state = {
            pairs: _this.props.user_pairs,
            user_id: _this.props.user_id
        };
        return _this;
    }

    _createClass(UserResults, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            var that = this;
        }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'th',
                                { scope: 'col', className: 'text-center', style: w5 },
                                _react2.default.createElement(
                                    'span',
                            ...
                            _react2.default.createElement(
                                'th',
                                { scope: 'col', className: 'text-center', style: w30 },
                                _Name
                            ),
                            _react2.default.createElement(
                                'th',
                            ...
                            _react2.default.createElement(
                                'th',
                                { scope: 'col', className: 'text-center', style: w12 },
                                _react2.default.createElement(
                                    'span',
                                    { className: 'd-none d-sm-block' },
                                    _Result
                    ...
                    _react2.default.createElement(
                        'tbody',
                        null,
                        this.state.pairs.map(function (item, index) {
                            return _react2.default.createElement(
                                'tr',
                                { key: index },
                                _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { 'data-id': item.p1_id, className: _this2.state.user_id == item.p1_id ? "participant bg-success" : "" },
                                    item.p1_name,
                                    ' ',
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-dark' },
                                        item.p1_rating_for_history
                                    ),
                                    '  ',
                                    item.rating_change_p1 > 0 ? _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-success' },
                                        '+',
                                        item.rating_change_p1
                                    ) : _react2.default.createElement(
                                        'span',
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { 'data-id': item.p2_id, className: _this2.state.user_id == item.p2_id ? "participant bg-success" : "" },
                                    item.p2_name,
                                    '  ',
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-dark' },
                                        item.p2_rating_for_history
                                    ),
                                    ' ',
                                    item.rating_change_p2 > 0 ? _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-success' },
                                        '+',
                                        item.rating_change_p2
                                    ) : _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-danger' },
                                        item.rating_change_p2
...
var _ResultsTable = __webpack_require__(40);
...
var _Tours = __webpack_require__(41);
...
var Pairing = function (_React$Component) {
    ...
    function Pairing(props) {
        ...
        _this.getActualData = _this.getActualData.bind(_this);
        _this.socketAddMessage = _this.socketAddMessage.bind(_this);
        return _this;
    }
    ...
    _createClass(Pairing, [{
        ...
        value: function componentDidMount() {
            ...
            if (this.state.tournament.is_online == 1 && typeof tour_choosed === "undefined") {
                ...
                self.socket = new _ws2.default(function (data) {
        ...
        key: 'handleWSData',
        value: function handleWSData(data) {
        ...
        value: function updateTournament() {
            this.getActualData();
        }
    }, {
        key: 'componentWillUnmount',
        ...
        key: 'saveResult',
        value: function saveResult(event) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    null,
                    this.state.tournament.is_closed == 1 ? _react2.default.createElement(
                        'h4',
                        null,
                        _react2.default.createElement(
                            'div',
                            { className: 'badge badge-danger starting' },
                            '\u0422\u0443\u0440\u043D\u0438\u0440 \u0437\u0430\u0432\u0435\u0440\u0448\u0435\u043D'
                        )
                    ) : null,
                    this.state.tournament.is_canceled == 1 ? _react2.default.createElement(
                        'h4',
                        null,
                        _react2.default.createElement(
                            'div',
                            { className: 'badge badge-info starting' },
                            '\u0422\u0443\u0440\u043D\u0438\u0440 \u043E\u0442\u043C\u0435\u043D\u0435\u043D'
                        )
                    ) : null,
                    !this.state.tournament.is_closed && this.state.tournament.is_active == 1 ? _react2.default.createElement(
                        'div',
                        null,
                        _react2.default.createElement(
                            'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                '\u0422\u0435\u043A\u0443\u0449\u0438\u0439 \u0442\u0443\u0440: ',
                                this.state.tournament.current_tour
                            )
                        )
                    ) : null,
                    this.state.tournament.is_online && !this.state.tournament.is_closed && !this.state.tournament.is_active ? _react2.default.createElement(
                        'div',
                        { className: 'badge badge-secondary starting' },
                        '\u0422\u0443\u0440\u043D\u0438\u0440 \u0441\u0442\u0430\u0440\u0442\u0443\u0435\u0442 \u0447\u0435\u0440\u0435\u0437 : ',
                        _react2.default.createElement(_Timer2.default, { timeleft: timeleft })
                    ) : null
                ),
                this.state.pairs != null && this.state.pairs.length ? _react2.default.createElement(
                    'table',
                    { className: 'table table-hover table-bordered table-sm mt-2' },
                    _react2.default.createElement(
                        'thead',
                        { className: 'thead-dark' },
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'th',
                                { scope: 'col', className: 'text-center hidden-lg-down', style: w30 },
                                _Name
                            ),
                            _react2.default.createElement(
                                'th',
                            ...
                            _react2.default.createElement(
                                'th',
                                { scope: 'col', className: 'text-center hidden-lg-down', style: w5 },
                                _react2.default.createElement(
                                    'span',
                                    { className: 'd-none d-sm-block' },
                                    _Points
                    ...
                    _react2.default.createElement(
                        ...
                        this.state.pairs.map(function (item, index) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { 'data-id': item.p1_id, className: 'participant' },
                                    ' ',
                                    item.p1_name,
                                    ' ',
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-dark' },
                                        item.is_over ? item.p1_rating_for_history : item.p1_rating
                                    ),
                                    ' ',
                                    item.rating_change_p1 > 0 ? _react2.default.createElement(
                                        'span',
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { className: 'text-center' },
                                    _this2.state.tournament.is_online === 1 ? _react2.default.createElement(_Link2.default, { tournament_id: _this2.state.tournament_id, p1_id: item.p1_id, p2_id: item.p2_id, id: item.id }) : null,
                                    typeof tour_id != "undefined" && tour_id != "null" && tour_id == current_tour && typeof _this2.state.owner !== "undefined" ? _react2.default.createElement(
                                        'select',
                                        _extends({ name: '', className: 'custom-select form-control-sm', id: '', defaultValue: JSON.stringify({
                                                p1_id: item.p1_id,
                                                p2_id: item.p2_id,
                                                p1_won: item.p1_won,
                                                p2_won: item.p2_won,
                                                game_id: item.id
                                            }) }, !item.p2_id || !item.p1_id ? disabled : "", { onChange: _this2.saveResult }),
                                        _react2.default.createElement(
                                            'option',
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { 'data-id': item.p2_id, className: 'participant' },
                                    ' ',
                                    item.p2_name,
                                    ' ',
                                    _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-dark' },
                                        item.is_over ? item.p2_rating_for_history : item.p2_rating
                                    ),
                                    ' ',
                                    item.rating_change_p2 > 0 ? _react2.default.createElement(
                                        'span',
                ...
                typeof tour_choosed === "undefined" ? _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_Tours2.default, { tournament: this.state.tournament }),
                    this.state.tournament.is_closed ? _react2.default.createElement(
                        'h5',
                        { className: 'mt-2 ' },
                        '\u0418\u0442\u043E\u0433\u043E\u0432\u043E\u0435 \u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435'
                    ) : this.state.tournament.is_active ? _react2.default.createElement(
                        'h5',
                        { className: 'mt-2 ' },
                        '\u041F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u0434\u043E \u0442\u0435\u043A\u0443\u0449\u0435\u0433\u043E \u0442\u0443\u0440\u0430'
                    ) : _react2.default.createElement(
                        'h5',
                        { className: 'mt-2 ' },
                        '\u0423\u0447\u0430\u0441\u0442\u043D\u0438\u043A\u0438'
                    ),
                    _react2.default.createElement(_ResultsTable2.default, { participants: this.state.participants, tournament: this.state.tournament })
                ) : null,
                _react2.default.createElement(
                    'div',
                    { className: 'modal', id: 'user_results_modal', tabIndex: '-1', role: 'dialog', 'aria-labelledby': 'exampleModalLabel', 'aria-hidden': 'true' },
                    _react2.default.createElement(
                        'div',
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: 'modal-body', id: 'user_results' },
                                _react2.default.createElement(_table2.default, { user_id: this.state.user_id, user_pairs: this.state.user_pairs })
                            ),
                            _react2.default.createElement(
                                'div',
...
$(function () {
    (0, _reactDom.render)(_react2.default.createElement(Pairing, null), document.getElementById('pairing'));
});
...
var Link = function (_React$Component) {
    ...
    function Link(props) {
        ...
        _this.state = {
            id: _this.props.id,
            p1_id: _this.props.p1_id,
            p2_id: _this.props.p2_id,
            tournament_id: _this.props.tournament_id
        };
        return _this;
    }
    ...
    _createClass(Link, [{
        ...
        value: function render() {
            ...
            return this.props.p1_id != null && this.props.p2_id != null ? _react2.default.createElement(
                'a',
                { href: href },
                '\u041F\u0430\u0440\u0442\u0438\u044F'
            ) : null;
                        ...
                        this.state.participants.map(function (item, index) {
                            return _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    item.name,
                                    '  ',
                                    item.is_active === 0 ? _react2.default.createElement(
                                        'span',
                                        { className: 'badge badge-danger' },
                                        'bye'
                                    ) : null
                                ...
                                _react2.default.createElement(
                                    'td',
                                    { style: width },
                                    _react2.default.createElement('a', { href: '', 'data-id': item.user_id, className: 'participant fa fa-eye' }),
                                    '\xA0',
                                    item.user_id ? _react2.default.createElement(Link, { id: item.user_id }) : null
                                )
                            );
                        })
                    )
...
function Link(props) {
    ...
    return _react2.default.createElement('a', { target: '_blank', href: link, className: 'fa fa-chart-line' });
}
...
var _ToursLink = __webpack_require__(42);

var _ToursLink2 = _interopRequireDefault(_ToursLink);
    ...
    _createClass(Tours, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                tours.length > 0 ? _react2.default.createElement(
                    'div',
                    { className: 'mt-2' },
                    ' \u0422\u0443\u0440\u044B :',
                    tours.map(function (item, index) {
                        return _react2.default.createElement(_ToursLink2.default, { key: index, tournament_id: _this2.state.tournament.id, tour_id: index });
                    })
                ) : null
            );
        }
...
function TourLink(props) {
    ...
    return _react2.default.createElement(
        'a',
        { className: 'btn ', href: href },
        tour_id + 1
    );
}

exports.default = TourLink;
