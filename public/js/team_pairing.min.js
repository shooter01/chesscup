        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.state.pairs.map(function (item, index) {
                    return _react2.default.createElement(
                        'div',
                        { className: 'mt-5 mb-5', key: index },
                        typeof item.users != "undefined" ? _react2.default.createElement(
                            'table',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'td',
                                        { scope: 'col', className: 'text-center pairing-team-thead', style: w5 },
                                        ' '
                                    ),
                                    _react2.default.createElement(
                                        'td',
                                        { scope: 'col', className: 'text-center pairing-team-thead', style: w30 },
                                        _this2.state.tournaments_teams[item.team_1_id].name,
                                        ' '
                                    ),
                                    _react2.default.createElement(
                                        'td',
                                    ...
                                    _this2.state.type == 20 && tour_id != "null" && tour_id == current_tour && typeof _this2.state.owner !== "undefined" ? _react2.default.createElement(
                                        'td',
                                        { scope: 'col', className: 'text-center pairing-team-thead', style: w12 },
                                        ' ',
                                        _react2.default.createElement(
                                            'select',
                                            _extends({ name: '', className: 'custom-select form-control-sm', id: '', defaultValue: JSON.stringify({
                                                ...
                                                }) }, !item.team_2_id || !item.team_2_id ? disabled : "", { onChange: _this2.saveResult }),
                                            _react2.default.createElement(
                                                'option',
                                            ...
                                            _this2.state.team_boards.map(function (board, index) {
                                                return _react2.default.createElement(
                                                    'option',
                                                    { key: index, value: JSON.stringify({
                                                            p1_id: item.team_1_id,
                                                            p2_id: item.team_2_id,
                                                            p1_won: board,
                                                            p2_won: _this2.state.team_boards.length - board
                                                        }) },
                                                    board,
                                                    ':',
                                                    _this2.state.team_boards.length - board
                                                );
                                            }),
                                            _react2.default.createElement(
                                                'option',
                                                { key: index, value: JSON.stringify({
                                                        p1_id: item.team_1_id,
                                                        p2_id: item.team_2_id,
                                                        p1_won: _this2.state.team_boards.length,
                                                        p2_won: 0
                                                    }) },
                                                _this2.state.team_boards.length,
                                                ':0'
                                            ),
                                            _react2.default.createElement(
                                                'option',
                                                { value: JSON.stringify({
                                                        p1_id: item.team_1_id,
                                                        p2_id: item.team_2_id,
                                                        p1_won: _this2.state.team_boards.length / 2,
                                                        p2_won: _this2.state.team_boards.length / 2
                                                    }) },
                                                _this2.state.team_boards.length / 2,
                                                ':',
                                                _this2.state.team_boards.length / 2
                                            )
                                        ),
                                        ...
                                        { scope: 'col', className: 'text-center pairing-team-thead', style: w12 },
                                        ' ',
                                        _this2.state.team_tour_points[item.team_1_id] || 0,
                                        ' : ',
                                        _this2.state.team_tour_points[item.team_2_id] || 0,
                                        ' '
                                    ),
                                    _react2.default.createElement(
                                        'td',
                                    ...
                                    _react2.default.createElement(
                                        'td',
                                        { scope: 'col', className: 'text-center pairing-team-thead', style: w30 },
                                        _this2.state.tournaments_teams[item.team_2_id] ? _this2.state.tournaments_teams[item.team_2_id].name : null,
                                        ' '
                                    )
                                )
                            ),
                            _react2.default.createElement(
                                'tbody',
                                null,
                                item.users.map(function (pair, index) {
                                    return _react2.default.createElement(
                                        'tr',
                                        { key: index },
                                        _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                ...
                                                pair.p1_rating_for_history
                                            ),
                                            pair.rating_change_p1 > 0 ? _react2.default.createElement(
                                                'span',
                                                { className: 'badge badge-success' },
                                                '+',
                                                pair.rating_change_p1
                                            ) : _react2.default.createElement(
                                                'span',
                                        ...
                                        _react2.default.createElement(
                                            'td',
                                            { className: 'text-center' },
                                            tour_id != "null" && tour_id == current_tour && typeof _this2.state.owner !== "undefined" ? _react2.default.createElement(
                                                'select',
                                                _extends({ name: '', className: 'custom-select form-control-sm', id: '', defaultValue: JSON.stringify({
                                                        p1_id: pair.p1_id,
                                                        p2_id: pair.p2_id,
                                                        p1_won: pair.p1_won,
                                                        p2_won: pair.p2_won
                                                    }) }, !pair.p2_id || !pair.p1_id ? disabled : "", { onChange: _this2.saveResult }),
                                                _react2.default.createElement(
                                                    'option',
                                                    { value: JSON.stringify({
                                                            p1_id: pair.p1_id,
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'span',
                                                { className: 'badge badge-dark' },
                                                pair.p2_rating_for_history
                                            ),
                                            pair.rating_change_p2 > 0 ? _react2.default.createElement(
                                                'span',
                                                { className: 'badge badge-success' },
                                                '+',
                                                pair.rating_change_p2
                                            ) : _react2.default.createElement(
                                                'span',
                                                { className: 'badge badge-danger' },
                                                pair.rating_change_p2
